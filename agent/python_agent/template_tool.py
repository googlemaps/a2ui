...
class BaseTemplateTool(BaseTool):
  ...
  def from_bundle(
    ...
    """Constructs a BaseTemplateTool dynamically from a TemplateBundle."""
    params = {
        "name": bundle.render_tool_name,
        "description": bundle.effective_tool_description,
        "template_name": bundle.name,
        "schema_class": bundle.schema_cls,
