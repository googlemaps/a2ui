...
const SVG_SERVICE: TemplateResult =
...
export const PLACE_PIN_MARKER_STYLES: CSSResult = css`
  ...
  .custom-marker-content-icon {
    ...
    &.custom-marker-content-icon--service svg {
      left: -4px;
      top: -2px;
    }
    ...
    &.custom-marker-content-icon--closed svg {
      left: -4px;
      top: -3px;
    }
  }
